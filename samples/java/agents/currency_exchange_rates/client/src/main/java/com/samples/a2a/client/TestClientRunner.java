 ...
 *
 * <p>Prerequisites: - JBang installed (see
 * https://www.jbang.dev/documentation/guide/latest/installation.html) - A
 * running Currency Agent
 * server (see README.md for instructions on setting up the agent)
 *
 * <p>Usage: $ jbang TestClientRunner.java
 *
 * <p>The script will communicate with the Currency Agent server and send the
 * message "how much is 10 USD in INR?" to demonstrate the A2A protocol
 * interaction.
 */
