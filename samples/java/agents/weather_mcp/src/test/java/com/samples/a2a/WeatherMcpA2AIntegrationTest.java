 ...
 */
@QuarkusTest
public class WeatherMcpA2AIntegrationTest {
    ...
    @Test
    public void testWeatherMcpViaA2AProtocol() throws Exception {
        // Mock Gemini response (MCP tools not available in test environment)
        ...
        // Send message
        Message message = A2A.toUserMessage("What's the weather in San Francisco?");
