# Multi-Language Agent Collaboration and Interoperability (A2A SDK 0.3.x)

> *⚠️ DISCLAIMER: THIS DEMO IS INTENDED FOR DEMONSTRATION PURPOSES ONLY. IT IS NOT INTENDED FOR USE IN A PRODUCTION ENVIRONMENT.*

> **SDK Version:** This host targets **`a2a-sdk` 0.3.x**. For the version compatible with `a2a-sdk` 1.0.0 and the Java A2A 1.0.0 agents, see [content_creation_v10](../content_creation_v10/README.md).
...
* **Host Agent** *(Python, Google ADK, A2A Python SDK 0.3.x)*: Acts as the central orchestrator for content creation, dynamically determining which agent to send a request to based on the task at hand.
* **Content Planner Agent** *(Python, Google ADK, A2A Python SDK 0.3.x)*: Receives a high-level description of the content that's needed and creates a detailed content outline.
...
```bash
cd samples/python/hosts/content_creation_v03
uv run .
```
