...
class TestAgentCard:
    ...
    def test_agent_card_has_correct_name(self, http_client: httpx.Client):
        ...
        assert "image" in card["name"].lower() or "crewai" in card["name"].lower()
...
class TestImageGeneration:
        ...
        request_payload = {
            ...
            "params": {
                "message": {
                    ...
                    "role": "user",
                    "parts": [
                        {"type": "text", "text": "Generate an image of a blue circle"}
                    ],
                }
            },
            "id": 1,
    ...
    def test_generated_image_has_valid_base64_data(self, http_client: httpx.Client):
        ...
        request_payload = {
            ...
            "params": {
                "message": {
                    "messageId": f"test-{uuid4().hex[:8]}",
                    "role": "user",
                    "parts": [{"type": "text", "text": "Generate an image of a red square"}],
                }
            },
            "id": 2,
        }
    ...
    def test_generate_image_with_detailed_prompt(self, http_client: httpx.Client):
        ...
        request_payload = {
            ...
            "params": {
                "message": {
                    "messageId": f"test-{uuid4().hex[:8]}",
                    "role": "user",
                    "parts": [{"type": "text", "text": "Generate a simple dot"}],
                }
            },
            "id": 99,
        }
        ...
        request_payload = {
            ...
            "params": {
                "message": {
                    "messageId": f"test-{uuid4().hex[:8]}",
                    "role": "user",
                    "parts": [{"type": "text", "text": "Generate a tiny image"}],
                }
            },
            "id": test_id,
        }
        ...
        request_payload = {
            ...
            "params": {
                "message": {
                    "messageId": f"test-{uuid4().hex[:8]}",
                    "role": "user",
                    "parts": [{"type": "text", "text": "Generate a green triangle"}],
                }
            },
            "id": 1,
        }
