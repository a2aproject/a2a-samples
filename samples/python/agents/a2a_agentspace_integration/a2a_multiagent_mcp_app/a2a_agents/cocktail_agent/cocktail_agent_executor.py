    ...
    def _init_agent(self) -> None:
        ...
        if self.agent is None:
            ...
            self.agent = LlmAgent(
                ...
                instruction="""You are a specialized cocktail assistant. Your primary function is to utilize the provided tools to retrieve and relay cocktail information in response to user queries. You can handle all inquiries related to cocktails,
drink recipes, ingredients,and mixology.You must rely exclusively on these tools for data and refrain from inventing information. Ensure that all responses include the detailed output from the tools used and are formatted in Markdown""",
                tools=[
                    MCPToolsetWithToolAccess(
                        ...
                        tool_set_name="cocktail_toolset",
                    ),
                ],
